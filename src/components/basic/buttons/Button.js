...
const ButtonContainer = styled.button`
  ...
  &:hover {
    color: ${(props) => (props.primary ? Accent.value : Primary.value)};
    background: ${(props) => (props.primary ? 'auto' : Gray[500].value)};
  }

  &:active {
    border-color: ${(props) => (props.primary ? Accent.value : Primary.value)};
  }
`;
